 ...
 */
final class Version20250829203552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(25) NOT NULL, prenom VARCHAR(25) NOT NULL, courriel VARCHAR(25) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, telephone INT NOT NULL, api_token VARCHAR(255) NOT NULL, type_utilisateur VARCHAR(255) NOT NULL, niveau_acces INT DEFAULT NULL, projet_cree VARCHAR(25) DEFAULT NULL, projet_participe VARCHAR(25) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
