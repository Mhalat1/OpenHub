...
const Projects = () => {
  ...
  const updateProject = async (projectId) => {
    ...
    try {
      const response = await fetch(
        `${API_URL}/api/modify/project/${projectId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const deleteProject = async (projectId, projectName) => {
    ...
    try {
      const response = await fetch(
        `${API_URL}/api/delete/project/${projectId}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  const createSkill = async () => {
    if (!newSkill.name || !newSkill.description || !newSkill.technoUtilisees) {
      showMessage(
        "❌ Skill name, description and technologies are required",
        "error",
      );
      return;
    }
  ...
  const filteredProjects = projects.filter(
    (proj) =>
      ...
      (proj.requiredSkills &&
        proj.requiredSkills.toLowerCase().includes(searchTerm.toLowerCase())),
  );
                  ...
                  <div className={styles.cardHeader}>
                    ...
                    <div className={styles.cardActions}>
                      <button
                        ...
                        disabled={
                          actionLoading.type === "updateSkill" &&
                          actionLoading.id === skill.id
                        }
                        title="Edit skill"
                      >
                        {actionLoading.type === "updateSkill" &&
                      ...
                      <button
                        ...
                        disabled={
                          actionLoading.type === "deleteSkill" &&
                          actionLoading.id === skill.id
                        }
                        title="Delete skill"
                      >
                  ...
                  <div className={styles.cardHeader}>
                    ...
                    <div className={styles.cardActions}>
                      <button
                        ...
                        className={styles.editButton}
                        disabled={
                          actionLoading.type === "updateProject" &&
                          actionLoading.id === proj.id
                        }
                        title="Edit project"
                      >
                        {actionLoading.type === "updateProject" &&
                      ...
                      <button
                        ...
                        className={styles.deleteButton}
                        disabled={
                          actionLoading.type === "deleteProject" &&
                          actionLoading.id === proj.id
                        }
            ...
            <div className={styles.formGrid}>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setProject({ ...project, requiredSkills: e.target.value })
                  }
                  className={styles.formInput}
                />
              </div>
            ...
            <div className={styles.formGrid}>
              ...
              <div className={styles.formGroup}>
                ...
                <span className={styles.charCount}>
                  {newSkill.description.length}/50
                </span>
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewSkill({
                      ...newSkill,
                      technoUtilisees: e.target.value,
                    })
                  }
                  className={styles.formInput}
                />
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewSkill({ ...newSkill, duree: e.target.value })
                  }
                  className={styles.formInput}
                />
              </div>
          ...
          >
            ...
            <div className={styles.formGrid}>
              ...
              <div className={styles.formGroup}>
                ...
                />
                <span className={styles.charCount}>
                  {editingSkill.description.length}/50
                </span>
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditingSkill({ ...editingSkill, duree: e.target.value })
                  }
                  className={styles.formInput}
                />
              </div>
            ...
            <button
              ...
              disabled={
                actionLoading.type === "updateSkill" &&
                actionLoading.id === editingSkill.id
              }
            >
              {actionLoading.type === "updateSkill" &&
              actionLoading.id === editingSkill.id ? (
        ...
        >
          ...
          >
            ...
            <button
              ...
              disabled={
                actionLoading.type === "updateProject" &&
                actionLoading.id === editingProject.id
              }
            >
              {actionLoading.type === "updateProject" &&
              actionLoading.id === editingProject.id ? (
